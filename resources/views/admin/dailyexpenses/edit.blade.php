    ...
    <div class="container-fluid">
        <form action="" method="post" id="brandForm" name="brandForm">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" name="title" id="title" class="form-control" placeholder="Name" value="{{$expense->title}}">
                            </div>
            ...
            <div class="pb-5 pt-3">
                ...
                <a href="{{route('dailyexpenses.index')}}" class="btn btn-outline-dark ml-3">Cancel</a>
            </div>
        </form>
    </div>
    <!-- /.card -->
...
<script>
    $("#brandForm").submit(function(event) {
        ...
        $.ajax({
            url: '{{ route("dailyexpenses.update", $expense->id) }}',
            type: 'put',
