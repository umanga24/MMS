...
<section class="content-header">
    <div class="container-fluid my-2">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Sells Products</h1>
            </div>
            @if(auth('admin')->user()->role == 1 || auth('admin')->user()->role == 3)
            <div class="col-sm-6 text-right">
                <a href="{{ route('productsells.create') }}" class="btn btn-primary">Add Record</a>
            </div>
            @endif
        </div>
    </div>
...
<section class="content">
    <div class="container-fluid">
        ...
        <!-- Filter Form -->
        <form action="{{ route('productsells.index') }}" method="GET" class="form-inline mb-3">
            <div class="form-group">
                ...
                <a href="{{ route('productsells.index', ['date' => 'all']) }}" class="btn btn-secondary">Show All</a>
            </div>
        </form>
                ...
                <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            @if(auth('admin')->user()->role == 1 || auth('admin')->user()->role == 3)
                                <a href="{{ route('productsells.edit', $product->id) }}">
                        ...
                        <tr>
                            ...
                            <td><strong>Rs. {{ $totalSales }}</strong></td>
                            <td></td>
                            <td></td>
                            <td></td>
                        </tr>
...
<script>
    function deleteproduct(id) {
        var url = '{{ route("productsells.delete", "ID") }}';
