    ...
    <div class="container-fluid my-2">
        <div class="row mb-2">
            ...
            <div class="col-sm-6 text-right">
                <a href="{{route('dailyincomes.create')}}" class="btn btn-primary">Add Record</a>
            </div>
            @endif
        </div>
    </div>
...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="card">
            <form action="{{ route('dailyincomes.index') }}" method="GET" class="form-inline mb-3">
                <div class="form-group">
                    ...
                    <a href="{{ route('dailyincomes.index', ['date' => 'all']) }}" class="btn btn-secondary">Show All</a>
                </div>
            </form>
                ...
                <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if(auth('admin')->user()->role == 1 || auth('admin')->user()->role == 3)
                                <a href="{{route('dailyincomes.edit', $expense->id)}}">
...
<script>
    function deleteExpense(id) {
        var url = '{{ route("dailyincomes.delete", "ID") }}';
