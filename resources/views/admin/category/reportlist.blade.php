...
<section class="content-header">
    <div class="container-fluid my-2">
        <div class="row mb-2">
            <div class="col-sm-6">
            <h1>All Day Report<h1><h5> Player List</h5>
            </div>
        </div>
    </div>
</section>
            ...
            <form action="{{ route('report.list') }}" method="get">
                <div class="card-header">
                    <div class="card-title">
                        <button type="button" onclick="window.location.href='{{ route("report.list") }}'" class="btn btn-default btn-sm">Reset</button>
                    </div>
                ...
                <table class="table table-hover text-nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><strong>Rs. {{ $totalDiscount }}</strong></td>
