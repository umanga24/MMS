        ...
        <div class="row align-items-center py-3 justify-content-between">
            ...
            <div class="col-lg-4 col-6">
                <a href="index.php" class="text-decoration-none">
                    <span class="h1 text-uppercase text-primary bg-dark px-2">MMS </span>
                    <span class="h1 text-uppercase text-dark bg-primary px-2 ml-n1">Skating</span>
                </a>
            </div>
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        ...
                        <picture>
                            ...
                            <!-- <source media="(min-width: 800px,  max-height: 900px)" srcset="{{ asset('front-assets/images/carousel-4.jpg')}}" /> -->
                            <img src="{{ asset('front-assets/images/carousel-4.jpg')}}" alt="Carousel Image" style="height: 100%; object-fit: cover;" />
                        </picture>
                    ...
                    <div class="carousel-item">
                        ...
                        <picture>
                            ...
                            <img src="{{ asset('front-assets/images/carousel-5.jpg')}}" alt="Carousel Image" style="height:100%; object-fit: cover;" />
                        </picture>
                    ...
                    <div class="carousel-item">
                        ...
                        <picture>
                            <source media="(max-width: 799px)" srcset="{{ asset('front-assets/images/carousel-6-m.jpg')}}" />
                            <!-- <source media="(min-width: 800px)" srcset="{{ asset('front-assets/images/carousel-6.jpg')}}" /> -->
                            <img src="{{ asset('front-assets/images/carousel-6.jpg')}}" alt="Carousel Image" style="height: 100%; object-fit: cover;" />
                        </picture>
